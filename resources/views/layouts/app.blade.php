...
<!-- Base Css Files -->
    ...
    <script src="https://kit.fontawesome.com/f62634f22d.js" crossorigin="anonymous"></script>
                    ...
                    @else
                            ...
                            <div class="topbar">
                                ...
                                <div class="topbar-left">
                                    <div class="text-center">
                                        {{--routing to home page after clicking the logo--}}
                                        <a href="{{ route('home') }}" class="logo"><i class="md md-terrain"></i> <span>Moltran </span></a>
                                    </div>
                                </div>
                        ...
                        @endguest
                            ...
                            <main class="py-4">
                                ...
                                <script src="{{ asset('admin/assets/jquery-slimscroll/jquery.slimscroll.j')}}s"></script>
